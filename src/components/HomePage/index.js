...
const HomePage = () => {
  ...
  const getRestaurants = () => {
    const axiosConfig = {
      headers: {
        auth: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IkNxMDRDU0hJcllKTU80ZVZ4YVppIiwibmFtZSI6IkxhaXMiLCJlbWFpbCI6ImxhaXNAbGFpcy5jb20iLCJjcGYiOiIxMTEuMTExLjExMS0xMiIsImhhc0FkZHJlc3MiOnRydWUsImFkZHJlc3MiOiJSLiBkb3MgQm9ib3MsIDE0MCwgMjAgLSBWaWxhIE4uIENvbmNlacOnw6NvIiwiaWF0IjoxNTk0NjU3NzA4fQ.WH4ETj3o-DhWhZidHQD5piHbq-BpqHrPEWCLgMhwUoU"
      }
    }
    axios
      .get
          ...
          <div>
            ...
            <FilterContainer>
              {restaurants
                ...
                .map(
                  (restaurant) => (
                    <FilterKey value={restaurant.category} key={restaurant.id} onClick={() => changeCategory(restaurant.category)}>{restaurant.category}</FilterKey>
                  ))}
            </FilterContainer>
            <RestaurantContainer>
              <CardRestaurant
